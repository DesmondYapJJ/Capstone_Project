...
def main():
    ...
    # Main panel setup
    # Set website details
    st.set_page_config(page_title ="Otter object detection",  
                       layout='centered')
    ...
    # Set app header
    help.header('Otter object detection app')
    
    # Set text and pass to sub_text function
    text = """
    <center> <br> Welcome to the Otter Object Detection App. </br> </center>
    <center> This app allows you to take/upload photos and detect otters in them using a tf lite model. 
    </center>
    """
    help.sub_text(text)
